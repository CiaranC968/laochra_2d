...
class PlayScreen:
    ...
    def play(self):
        PLAY_GAME = config_service.create_button((config['screen_width'] // 2, 250), "New Game", config['font_size'], None,)
        PLAY_LOAD = config_service.create_button((config['screen_width'] // 2, 400), "Load Game", config['font_size'], None)
